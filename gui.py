...
class GUI():
    ...
    def init_plot(self):
        ...
        for key in self.quads:
            ...
            self.quads[key]['hub'], = self.ax.plot([], [], [], marker='o', color='green', markersize=6,
                                                   antialiased=False)
            quad_lines.append(self.quads[key]['l1'])
            quad_lines.append(self.quads[key]['l2'])
            quad_lines.append(self.quads[key]['hub'])
        return quad_lines
    ...
    def update(self):
        for key in self.quads:
            ...
            return self.quads[key]['l1'], self.quads[key]['l2'], self.quads[key]['hub']
